...
export const metadata = { title: 'Appendix D: NUMA Topology Interrogation' }

export default async function AppendixPage() {
  const raw = await loadMarkdown('intel/appendix-d.md')
      ...
      <div className="flex gap-0">
        <article className="flex-1 min-w-0">
          <div className="mb-10 pb-8 border-b border-border-primary">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-text-primary">NUMA Topology Interrogation</h1>
          </div>
