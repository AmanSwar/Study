...
export const metadata = { title: 'Appendix A: MLPerf Benchmarks Reference' }

export default async function AppendixPage() {
  const raw = await loadMarkdown('MLsys/appendices/appendix_a_mlperf_benchmarks.md')
      ...
      <div className="flex gap-0">
        <article className="flex-1 min-w-0">
          <div className="mb-10 pb-8 border-b border-border-primary">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-text-primary">MLPerf Benchmarks Reference</h1>
          </div>
